    ...
    return(
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          <Text style={{color:'#ff1493', fontSize:18, fontWeight:'bold',marginLeft:55}}>USERNAME</Text>
          ...
          <Text style={{color:'#ff1493', fontSize:18, fontWeight:'bold',marginLeft:55}}>PASSWORD</Text>
          <View style={{alignItems:'center'}}>
            <TextInput
              style={styles.loginBox}
              secureTextEntry = {true}
          ...
          <View style={{alignItems:'center'}}>
            <TouchableOpacity
              ...
              >
              <Text style={{color:'#ff1493', fontSize:18, fontWeight:'bold'}}>LOGIN</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.button}
              onPress={()=>{
              ...
              >
                <Text style={{color:'#ff1493', fontSize:18, fontWeight:'bold'}}>SIGN UP</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
